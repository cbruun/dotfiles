...
- Truth is more important than politeness. Correct me if I'm wrong
...
- Never make assumptions about code/infrastructure. You must verify
- Verify capabilities before suggesting solutions or commands
- Inspect before proposing. Read relevant files and do not assume or guess
